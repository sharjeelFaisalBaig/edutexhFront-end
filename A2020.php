		...
		<div class="col-md-6">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb pl-0">
					...
					<li class="breadcrumb-item active" aria-current="page">Batch B-2020</li>
				</ol>
			</nav>
		</div>
						...
						<form class="needs-validation clearfix" novalidate="">
							<div class="form-row">
								<div class="col-md-12 mb-3">
									<label for="validationCustom29">Course</label>
									...
									<div class="input-group">
										<select class="form-control">
											<option>G1-B-2020</option>
										</select>
									</div>

									<button class="btn btn-primary width70" type="submit">Submit</button>
								</div>
							</div>
						</form>
					</div>
