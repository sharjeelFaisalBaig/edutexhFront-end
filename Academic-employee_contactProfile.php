    ...
    <div class="row">
        <div class="col-md-12 m-auto">
            <div class="ms-panel-header">
                <h6 class="my-4 d-md-inline"><b>Students Info | </b><small>Contact Details</small></h6>
        ...
        <div class="col-md-12 my-4">
            <div class="table-responsive">
                <table class="table table-bordered thead-primary table-striped">
                    <tbody>
                        <tr>
                            <th class="cstm_thead">Office Phone</th>
                            <td>(021)00000</td>
                        </tr>
                        <tr>
                            <th class="cstm_thead">Office Phone 2</th>
                            <td>(021)00000</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th class="cstm_thead">Home Phone</th>
                            <td>(021)21234213</td>
                        </tr>
                        <tr>
                            <th class="cstm_thead">FAX</th>
                            <td>9271678</td>
                        </tr>
                    </tbody>
                </table>
