...
<div class="ms-content-wrapper">
	...
	<div class="col-md-12">
        ...
        <div class="ms-panel w-20">
            <div class="ms-panel-body">
                <div class="">
                    <nav class="ms-card-head border">
                        <ul class="ms-list ms-task-block">
                            <li class="">
                                <span>List of teachers (36)</span>
                            </li>
                        </ul>
                    </nav>
                </div>
                <div class="ms-card ms-widget ms-card-fh">
                    <div class="ms-card-body border" style="overflow-y: auto; height: 200px;">
                        <ul class="ms-list ms-task-block">
                            <li class="">
                                <span> Asadullah Shah</span>
                            </li>
                            <li class="">
                                <span>Amir Hussain</span>
                            </li>
                            <li class="">
                            ...
                            <li class="">
                                <span>Qasim Khalid</span>
                            </li>
                            <li class="">
                                <span>Noman Ali</span>
                            </li>
                            <li class="">
                                <span>Azhar Shahzad</span>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="ms-panel w-80">
            <div class="ms-panel-body">
                <div class="">
                    <table class="table timesheet">
                        <thead>
                            <th colspan="5">Employee name: Asadullah Shah (E16)</th>
