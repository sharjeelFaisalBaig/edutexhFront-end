        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Stop</li>
              </ol>
          </nav>
      </div>
      <div class="col-md-12">
          ...
          <div class="ms-panel-header">
            <div>
                ...
                <div class="dropdown float-right">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#modal-1">New Stop</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="ms-panel w-100">
        <div class="ms-panel-header text-left pb-1">
         ...
         <p>Create all stops vehicles travel during an academic year</p>
     </div>
        ...
        <div class="ms-panel w-50">
            ...
            <div class="ms-panel-body">
                <div class="alert alert-warning text-center">
                    <strong>Vehicle Stop Created Successfully</strong>
                </div>
            </div>
            ...
            <table class="table table-hover thead-primary">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-left">Land Mark</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <a class="ml-5" href="">Inactivate</a>
                        </td>
                    </tr>
