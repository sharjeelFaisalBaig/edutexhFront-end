    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ms-panel-header">
                <h6 class="my-4 d-md-inline"><b>Admission | </b><small>Step 4</small></h6>
            </div>
        </div>
        <div class="col-md-12">
    ...
    <div class="col-md-8 m-auto">
        ...
        <div class="col-md-12 mt-4">
            <div class="col-md-4 m-auto">
                ...
                <a href="#" class="btn btn-primary d-inline" data-toggle="modal" data-target="#modal_confirmGuardian">Finish</a>
            </div>
        </div>
    </div>
</div>
