    ...
    <div class="row">
        <div class="col-md-12 m-auto">
            <div class="ms-panel-header">
                <h6 class="my-4 d-md-inline"><b>Students Info | </b><small>Bank Details</small></h6>
        ...
        <div class="col-md-12 my-4">
            <div class="table-responsive">
                <table class="table table-bordered thead-primary table-striped">
                    <tbody>
                        <tr>
                            <th class="cstm_thead">Bank Name</th>
                            <td>HBL</td>
                        </tr>
                        <tr>
                            <th class="cstm_thead">Bank Address</th>
                            <td>Samblagah</td>
                        </tr>
                        <tr>
                            <th class="cstm_thead">Account Number</th>
                            <td>1.234233E + 14</td>
                        </tr>
                    </tbody>
                </table>
