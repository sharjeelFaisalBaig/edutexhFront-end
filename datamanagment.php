...
<div class="ms-content-wrapper">
      ...
      <div class="ms-panel-header">
                <div>
                    ...
                    <div class="dropdown float-right">
                        <button class="btn btn-primary" onclick="window.location.href='datamanagmentform.php'">New</button>
                    </div>
                </div>
      </div>
    </div>
    ...
    <div class="col-md-12 text-center content-center">
        <div class="ms-panel w-50 offset-3">
            <div class="ms-panel-body">
                <div class="">
                    <table class="table table-hover thead-primary">
                        ...
                        <tr>
                            ...
                            <td class="text-left"><a href="datamanagmentcategory.php">Sample 1</a></td>
                            <td>
