	...
	<div class="row">
		<div class="col-md-12">
			<div class="ms-panel-header pt-0">
				<h6 class="d-md-inline">Asset Liability Management</h6> |  <small>Asset View</small>
				...
				<div class="ms-panel-body">
					<div class="table-responsive mt-4">
						<div class="alert alert-warning text-center mb-4">
							<strong>Asset Updated Successfully</strong>
						</div>
						<table id="data-table-4" class="ms-card table w-100 thead-primary table-bordered">
							...
							<tbody>
								...
								<tr>
									<td>Academic Block - I</td>
									<td>11/05/2020</td>
									<td class="text-disabled" style="cursor: not-allowed;">Rs 1200000.00</td>
									<td>
										<a href="javascript:void();" class="nav-item" data-toggle="modal" data-target="#modal-2">Edit</a> |
										<a href="javascript:void();" class="nav-item">Delete</a>
									</td>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h6 class="modal-title has-icon ms-icon-round ">Edit Asset</h6>
					...
					<div class="form-row mt-2">
						...
						<div class="col-md-6">
							<div class="input-group">
								<input type="text" class="form-control" id="validationCustom03" placeholder="Academic Block - I">
							</div>
						</div>
						<div class="col-md-4">
						...
						<div class="col-md-6">
							<div class="input-group">
								<input type="text" class="form-control" id="validationCustom03" placeholder="Asset Value of Academic Block - I">
							</div>
						</div>
						<div class="col-md-4">
						...
						<div class="col-md-6">
							<div class="input-group">
								<input type="text" class="form-control" id="validationCustom03" placeholder="12000000">
							</div>
						</div>
                        <div class="col-md-4">
                            <label class="mt-2">Make Asset Inactive? </label>
                        </div>
                        <div class="col-md-6">
