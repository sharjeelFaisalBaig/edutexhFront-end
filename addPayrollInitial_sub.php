...
<div class="col-md-8 m-auto">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
            <a class="btn btn-primary my-1" type="submit" href="Administration-HumanResource_employeeManagement_employeeAdmission_addPayrollFinal_sub.php">Save And Proceed</a>     
            </div>
        </div>
