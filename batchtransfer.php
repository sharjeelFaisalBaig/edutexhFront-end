		...
		<div class="col-md-7">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb pl-0">
					...
					<li class="breadcrumb-item active" aria-current="page">Batch Transfer</li>
				</ol>
			</nav>
		</div>
						...
						<form class="needs-validation clearfix" novalidate="">
							<div class="form-row">
								<div class="col-xl-4 col-md-12 mb-3">
									<label for="validationCustom29">Select a course</label>
						...
						<div class="table-responsive table-bordered">
							<table class="table w-100 thead-primary">
								...
								<tbody>
									<tr>
										<td>GI-A-2020</td>
										<td><a href="graduation.php">Graduation</a></td>
										<td>
											<a href="transferaction.php">Batch Transfer</a>
										</td>
									</tr>
									<tr>
										<td>GI-B-2020</td>
