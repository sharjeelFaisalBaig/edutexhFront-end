...
<div class="col-md-8 m-auto">
        ...
        <div class="col-md-2">
          <a class="btn btn-primary ml-2" type="submit" href="Administration-HumanResource_employeeManagement_employeeAdmission_addToLeaveGroup_sub.php">Skip And Proceed</a>
        </div>
