        ...
        <div class="col-md-12">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
                ...
                <li class="breadcrumb-item"><a href="">Transport Report</a></li>
                <li class="breadcrumb-item active" aria-current="page">Transport Allocation Report</li>
            </ol>
        </nav>
    </div>
    <div class="col-md-12">
                    ...
                    <form class="needs-validation clearfix" novalidate="">
                        <div class="form-row">
                            ...
                            <div class="col-md-12 mb-3">
                             ...
                             <div class="col-md-12 mb-3">
                                <div class="row">
                                    <div class="col-4"> <label for="validationCustom18">Class</label></div>
                                    <div class="col-8">
                                       <select class="form-control">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="row">
                                    <div class="col-4"> <label for="validationCustom18">Batch</label></div>
                                    <div class="col-8">
                                       <select class="form-control">
                             ...
                             <div class="col-md-12 mb-3">
                                <div class="row">
                                    <div class="col-4"> <label for="validationCustom18">Selection Type</label></div>
                                    <div class="col-8">
                                       <select class="form-control">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="row mt-3">
                                    <div class="col-6 m-auto">
                                        <input type="submit" value="View Report" class="btn btn-primary" name="">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="ms-panel-header">
        <div>
            ...
            <div class="dropdown float-right">
                <button class="ml-3 btn btn-primary">CSV Report</button>
                ...
                <table class="table table-hover thead-primary">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-left">Admission Number</th>
                            <th scope="col" class="text-left">Batch Name</th>
                            <th scope="col" class="text-left">Transport Allocation Status</th>
                            <th scope="col" class="text-left">Transport Allocation Type</th>
                            <th scope="col" class="text-left">Pickup Route</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="text-left">Two way Transport</td>
                            <td class="text-left">Comittie Chowk</td> 
                            <td class="text-left">RIJ-23</td>        
                        </tr>
                         <tr>
                            <td class="text-left">1</td>
                            <td class="text-left">Faizan Javed </td>
    ...
    <div class="modal-body">
        <div class="card">
            ...
            <div class="col-6">
                ...
                <span> Transport Allocation Status </span>
            </div>
             <div class="modal-notice">
                  <label class="ms-checkbox-wrap">
                    <input type="checkbox" value="">
                ...
                <span> Transport Allocation Type</span>
            </div>
             <div class="modal-notice">
                  <label class="ms-checkbox-wrap">
                    <input type="checkbox" value="">
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary shadow-none" data-dismiss="modal">View report</button>
</div>
