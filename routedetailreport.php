        ...
        <div class="col-md-12">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Route Details Report</li>
            </ol>
        </nav>
    </div>
    <div class="col-md-12">
                ...
                <table class="table table-hover thead-primary">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-left">Driver Name</th>
                            <th scope="col" class="text-left">Driver Phone no</th>
                            <th scope="col" class="text-left">Stops</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="text-left">Shiraz Ahmed</td>
                            <td class="text-left">20202323</td>
