		...
		<div class="col-12">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb pl-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Employee Department</li>
                </ol>
            </nav>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="exampleName" placeholder="Economics">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <label class="">Deparment Code</label>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="exampleName" placeholder="ECO">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h6 class="modal-title">Edit Employee Department</h6>
