...
<div class="ms-content-wrapper">
	<div class="row">
        ...
        <div class="col-md-2">
            <button class="btn btn-primary" data-toggle="modal" data-target="#modal-1">Activities</button>
        </div>
        <div class="col-md-12">
            <hr>
        </div>
		<div class="col-md-8">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb pl-0">
					...
					<li class="breadcrumb-item"><a href="Academic-TimeTable_sub.php">AsadUllah Shah</a></li>
	...
	<div class="col-md-12">
        <div class="col-md-10 my-4 ms-panel-body">
            <div class="form-group row my-3">
                <label class="col-sm-3 col-form-label">Select a Timetable</label>
                <div class="col-sm-4">
