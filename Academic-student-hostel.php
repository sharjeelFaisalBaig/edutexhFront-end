    ...
    <div class="row">
        <div class="col-md-12 m-auto">
            <div class="ms-panel-header">
                <h6 class="my-4 d-md-inline"><b>Students Info | </b><small>Hostel</small></h6>
            ...
            <div class="col-md-12 my-4">
                <div class="table-responsive">
                    <table class="table table-bordered thead-primary table-striped">
                        <tbody>
                            <tr>
                                <th class="cstm_thead">Hostel</th>
                                <td>Marvi Hostel</td>
                            </tr>
                            <tr>
                                <th class="cstm_thead">Room No.</th>
                                <td>21</td>
                            </tr>
                            <tr>
                                <th class="cstm_thead">Rent</th>
                                <td>RS 5000.00</td>
                            </tr>
                        </tbody>
                    </table>
