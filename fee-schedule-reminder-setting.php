        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Fee Schedule Reminder Settings</li>
                </ol>
            </nav>
        </div>
        <div class="col-xl-12 col-md-12">
            <div class="ms-panel-body">
            	<small>Set reminders and help Students and Parents keep track of fee collection dates. The settings you configure here can be applied when scheduling a fee collection.</small>
                <br>
                <small>Modifying the current settings will affect only the new fee schedules, but not the existing ones.</small>
                    ...
                    <div class="row">
                    	<div class="col-md-6 mb-3">
                    		...
                    		<div class="ms-card p-3 text-muted">
                                Reminder: Payment for {Fee Collection Name} scheduled from {Start Date} to {End Date}
                            </div>
                            <p class="font-weight-bold">Email Message</p>
                            <div class="ms-card p-3 mb-4">
                                <p class="text-muted">Hi {user}</p>
                                <p class="text-muted">Payment for {Fee Collection Name} scheduled from {Start Date} to {End Date}</p>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="ms-card p-3">
                                <p class="font-weight-bold text-muted">Reminder: Payment for Annual Fees scheduled from 15 February 2015 to 19 February 2015</p>
                                <div style="margin-top: 100px;">
                                    <p class="text-muted">Hi Mary Ann,</p>
                                    <p class="text-muted">Payment for Annual Fees has been scheduled from 15 February 2015 to 19 February 2015.</p>
                                </div>
                                <p class="text-muted" style="margin-top: 45px;">Students, please pay the Annual Fees before the due date to avoid fine.</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="ms-card p-3">
                                <p class="text-muted">
                                    Hi Mary Ann,<br>
                                    Payment for Annual Fees is scheduled from 15 February 2015 to 19 February 2015.
                                    Thanks!
                                </p>
                            </div>
                        </div>
