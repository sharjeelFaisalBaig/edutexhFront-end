        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Route Addional Details</li>
              </ol>
          </nav>
      </div>
      <div class="col-md-12">
    ...
    <div class="ms-panel w-100">
        <div class="ms-panel-header text-left pb-1">
         <h5><i class="fa fa-truck"></i> Route Settings</h5>
         <p>Configure fields to capture additional data regarding a route</p>
     </div>
        ...
        <div class="ms-panel w-50">
            ...
            <div class="ms-panel-body">
                <div class="alert alert-warning text-center">
                    <strong>Route Additional Details Created</strong>
                </div>
            </div>
        ...
        <div class="">
            <table class="table table-hover thead-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-left">Nearest Hospital</td>
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-header">
                        <h3 class="modal-title has-icon ms-icon-round ">Create New Route Addional Detail</h3>
     ...
     <div class="modal fade" id="modal-2" tabindex="-1" role="dialog" aria-labelledby="modal-2">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-header">
                        <h3 class="modal-title has-icon ms-icon-round ">Edit Route Addional Detail</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                      </div>
