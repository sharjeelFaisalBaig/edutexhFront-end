        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Send SMS to Employees</li>
                </ol>
            </nav>
        </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label for="validationCustom25">Select a Department</label>
                                            ...
                                            <div class="ms-card-body">
                                                <ul class="ms-list ms-task-block">
                                                    <li class="ms-list-item">
                                                        ...
                                                        <span class="text-disabled">Faizan Javed (E8)</span>
                                                    </li>
                                                    <li class="ms-list-item">
                                                        <label class="ms-checkbox-wrap">
                                                    ...
                                                    <li class="ms-list-item">
                                                        ...
                                                        <span> Muhammad Sufyan Shaikh (E1) </span>
                                                    </li>
                                                    <li class="ms-list-item">
                                                        <label class="ms-checkbox-wrap">
                                                        ...
                                                        <span>Rashid Ahmed (E3)</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <small>Note : Employees cannot be selected if Employees Doesn't have mobile number</small>
                                    </div>
                                    <div class="col-md-6">
