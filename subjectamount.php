		...
		<div class="col-md-7">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb pl-0">
					...
					<li class="breadcrumb-item active">Grade 1</li>
				</ol>
			</nav>
		</div>
						...
						<form class="needs-validation clearfix" novalidate="">
		                    <div class="form-row">
		                     	<div class="col-md-12 mb-3">
		                        	...
		                        	<label for="validationCustom29">Subject</label>
			                        ...
			                        <label for="validationCustom30">Amount</label>
			                        <div class="input-group">
			                          <input type="text" class="form-control" placeholder="Enter Amount Here" name="">
			                        </div>
		                       	 	<button class="btn btn-primary width70" type="submit">Save</button>
		                      	</div>
		                    </div>
	                	</form>
	            	</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="needs-validation" novalidate>
					...
					<button class="btn btn-primary mt-4 d-block w-100" type="submit">Add Batch</button>
				</form>
			</div>
		</div>
	</div>
