        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-0">
                    ...
                    <li class="breadcrumb-item"><a href="coursename.php">Play Group</a></li>
                    <li class="breadcrumb-item active" aria-current="page">PG-Pink</li>
                </ol>
            </nav>
        </div>
       ...
       <div class="ms-panel-header">
                 <div>
                    <div class="float-left">
                        <h5>Tutor :  <span></span></h5>
                        <h5>Student :  <span>33</span></h5>
                    </div>
                </div>
      </div>
    </div>
