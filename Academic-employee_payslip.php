...
<div class="ms-content-wrapper">
    <div class="row">
        <div class="col-md-12 m-auto">
            <div class="ms-panel-header">
                <h6 class="my-4 d-md-inline"><b>Employees | </b><small>Pay Slip</small></h6>
    ...
    <div class="col-md-8 m-auto">
        <div class="col-md-8 m-auto">
            ...
            <hr>
            <div class="row mt-4">
                <label class="col-md-4 mt-2">Select Month & Year</label>
                <div class="col-md-6">
                    <select class="form-control">
                        <option selected>Seelct Month & Year</option>
                        <option value="1">June 2020</option>
                        <option value="2">July 2020</option>
                    </select>
                </div>
            </div>
            <div class="row mt-4">
                <h5 class="col-md-12">Pay Slip Period</h5>
            </div>
            <div class="row">
