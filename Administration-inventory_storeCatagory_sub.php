    ...
    <div class="col-md-12">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb pl-0">
          ...
          <li class="breadcrumb-item active" aria-current="page">Create A Store Catagory</li>
        </ol>
      </nav>
    </div>
        ...
        <div class="col-md-12">
            <div class="ms-panel-header">
                <h6>Inventory | <small> Create A Store Catagory</small></h6>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="alert alert-warning text-center my-4">
                    <strong>Store Catagory Was Sucessfully Created</strong>
                </div>
            </div>
            <div class="col-md-2"></div> 
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="storeName" placeholder="Name Of Store" required>
            </div>
            <div class="col-md-2"></div>
        </div>
