        ...
        <div class="col-md-12">
         <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Overall Salary Report</li>
            </ol>
        </nav>
    </div>
    <div class="col-md-12">
                ...
                <table class="table table-hover thead-primary">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-left">Total Earning (RS)</th>
                            <th scope="col" class="text-left">Total Deduction (RS)</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-left">232323</td>
                            <td class="text-left">2323232</td>
