...
<div class="ms-content-wrapper">
    <div class="row">
        ...
        <div class="col-md-4 text-md-right">
            <a href="javascript:void();" data-toggle="modal" data-target="#modal-3" class="btn btn-primary width70 m-auto">Create Finance Category</a>
        </div>
                        ...
                        <table id="data-table-4" class="ms-card table w-100 thead-primary table-bordered">  
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <a href="" class="nav-item" data-toggle="modal" data-target="#modal-4">Edit</a> |
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation mb-2" novalidate>
                    ...
                    <div class="form-row mb-2">
                        <div class="col-md-4">
                            <label class="mt-2">Is this Under Income? </label>
                        </div>
