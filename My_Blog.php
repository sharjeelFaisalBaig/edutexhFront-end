...
<div class="ms-content-wrapper">
	<div class="row">
		...
		<div class="col-md-5 text-md-right">
			<button class="btn btn-primary width70 m-auto" data-toggle="modal" data-target=".bd-example-modal-lg" type="submit">New Post</button>
		...
		<div class="col-md-10 m-auto">
			...
			<div class="ms-panel-body">
				<div class="alert alert-warning text-center my-4">
					<strong>Please create a blog first</strong>
				</div>
				<form class="needs-validation mb-5" novalidate>
					<div class="form-row">
						<div class="col-md-4 offset-md-4">
							...
							<button class="btn btn-primary width70 m-auto" type="submit">Save</button>
						</div>
					</div>
				</form>
				<div class="col-md-12">
					<div class="form-group row show_search_bar d-none">
						<label class="col-sm-2 col-form-label">Search Blogs</label>
						<div class="col-sm-8">
				...
				<div class="table-responsive">
					<table id="data-table-4" class="ms-card table w-100 thead-primary  table-striped">
						<tbody>
							<tr>
								<td class="width390"><a href="My_Blog_science.php"><strong>Science</strong></a></td>
								<td><i class="fas fa-comment-alt font-10"></i>1</td>
								<td><i class="fas fa-star font-10"></i>1</td>
								<td>08 May 2020</td>
								<td class="text-right">
									<a href="" class="nav-item" data-toggle="modal" data-target="#modal_edit">Edit</a> |
									<a href="" class="nav-item">Delete</a> |
									<a href="" class="nav-item">Unpublish</a>
								</td>
							</tr>
						</tbody>
					</table>
