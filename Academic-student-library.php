    ...
    <div class="row">
        <div class="col-md-12 m-auto">
            <div class="ms-panel-header">
                <h6 class="my-4 d-md-inline"><b>Students Info | </b><small>Library</small></h6>
                <div class="float-md-right">
                    ...
                    <a class="dropdown-item" href="Academic-certificate_individualCertificate_sub.php">Generate TC</a>
                        ...
                        <a class="dropdown-item" href="Academic-student-transport.php">Transport</a>
            ...
            <div class="col-md-12 my-4">
                <div class="table-responsive">
                    <table class="table table-bordered thead-primary">
                        ...
                        <tbody>
                            <tr>
                                <td><p class="ml-md-5">Tareekh-E-Pakistan (Due-Date:- 31-2-2020)</p></td>
                            </tr>
                            <tr>
                                <td><p class="ml-md-5">Masail-E-Fiqah (Due-Date:- 31-2-2020)</p></td>
                            </tr>
                            <tr>
                                <td><p class="ml-md-5">Masail-E-Namaz (Due-Date:- 31-2-2020)</p></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
