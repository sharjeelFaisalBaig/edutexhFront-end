    ...
    <div class="row">
        <div class="col-md-12 m-auto">
            <div class="ms-panel-header">
                <h6 class="my-4 d-md-inline"><b>Students Info | </b><small>Personal Profile</small></h6>
            ...
            <div class="table-responsive">
                <table class="table table-bordered thead-primary table-striped">
                    <tbody>
                        ...
                        <tr>
                            <th class="cstm_thead">Marital Status</th>
                            <td>Widowed</td>
                        </tr>
                        <tr>
                            <th class="cstm_thead">No. Of Childrens</th>
                            <td>2</td>
                        </tr>
                        <tr>
                            <th class="cstm_thead">Father Name</th>
                            <td>Dr. Abdul Qadeer Khan</td>
                        </tr>
                        <tr>
                            <th class="cstm_thead">Mother Name</th>
                            <td></td>
                        </tr>
                        <tr>
                            <th class="cstm_thead">Spouse's Name</th>
                            <td></td>
                        </tr>
                        <tr>
